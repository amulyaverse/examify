...
export default function AuthPage() {
  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log("Signing up with:", { name, email, passwordLength: password?.length });
    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "#f0f4ff" }}>
      <div className="flex w-full max-w-4xl rounded-3xl overflow-hidden" style={{ background: "#ffffff", boxShadow: "0 30px 80px rgba(56,107,255,0.13)", minHeight: "560px" }}>
        ...
        <div className="flex flex-col justify-center w-full md:w-1/2 px-10 py-12">
          ...
          {/* Tabs */}
          <div className="flex mb-8" style={{ background: "#f0f4ff", borderRadius: 12, padding: 4, gap: 4 }}>
            <button
              onClick={() => { setTab("signin"); setError(""); }}
              className="flex-1 py-2 text-sm font-semibold"
              style={{
                borderRadius: 9,
                background: tab === "signin" ? "#386bff" : "transparent",
                color: tab === "signin" ? "#fff" : "#8a94a6",
                border: "none",
                cursor: "pointer",
              }}
            >
            ...
            <button
              ...
              style={{
                borderRadius: 9,
                background: tab === "signup" ? "#386bff" : "transparent",
                color: tab === "signup" ? "#fff" : "#8a94a6",
                border: "none",
                cursor: "pointer",
              }}
            >
          ...
          <div style={{ display: tab === "signin" ? "block" : "none" }}>
            <form onSubmit={handleSignIn}>
              ...
              <div className="flex justify-end mb-6">
                <a href="#" style={{ fontSize: 12, color: "#386bff", textDecoration: "none" }}>Forgot password?</a>
              </div>
          ...
          <button style={{ width: "100%", padding: "11px", background: "#fff", border: "1.5px solid #e8eeff", borderRadius: 12, fontSize: 13, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
